...
5. **Push Changes and [Create a Pull Request](https://opensource.com/article/19/7/create-pull-request-github)** 🔄  
   Push your branch to GitHub and create a pull request. Make sure to include a screenshot of your accepted solution on the coding platform in the pull request description. Your changes will then be reviewed and merged.
---
...
- [Ishita Pahuja](https://github.com/ishitapahuja1)
